...
const SentryHeader: React.FC<SentryHeaderProps> = ({
  ...
  return <header className="sentry-panel flex items-center justify-between h-auto min-h-[80px] mb-4 py-2 px-4">
      ...
      <div className="flex items-center gap-4">
        ...
        maxWidth: '63px'
      }} src="/lovable-uploads/8245c862-16cc-476f-8364-0fc15ddaa728.png" className="h-[150px] w-[169px] border-0 border-none opacity-100 shadow-none rounded-none object-fill" />
        ...
        }} className="text-sentry-accent/80 font-medium text-base font-serif text-right">            constructed by YOD ALEF Engineering company                                                 
